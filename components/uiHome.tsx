...
const HomeScreen = () => {
  ...
  return (
    <>
      {/* Add Inter font and Plus Jakarta Sans from Google Fonts */}
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500&family=Plus+Jakarta+Sans:wght@400;700&display=swap');
      `}</style>
      
      <div className="flex flex-col items-center justify-between min-h-screen bg-gray-50 px-4 sm:px-6 py-8 font-['Inter',sans-serif]">
        <div className="flex-grow flex flex-col items-center justify-center w-full max-w-md mx-auto">
          <header className="text-center mb-4">
            <h1 
              className="text-3xl sm:text-4xl font-light tracking-wide text-blue-800 mb-3" 
